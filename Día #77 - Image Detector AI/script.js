// Establecer el número de etiquetas a mostrar por página
const tagsPerPage = 20;

// Evento para el botón de subida
document.getElementById('uploadButton').addEventListener('click', async () => {
    // Elementos y manejo de archivos
    ...
    // Si no se selecciona ningún archivo, mostrar un mensaje toast
    ...
    try {
        // Mostrar modal de subida y reiniciar barra de progreso
        uploadModal.style.display = 'block';
        uploadProgress.style.width = '0%';

        // Subir imagen a Imagga
        ...
        showToast('¡Ocurrió un error al procesar la imagen!');
    } finally {
        // Ocultar el modal de subida después del procesamiento
        uploadModal.style.display = 'none';
    }
});

// Función para mostrar resultados del análisis de colores
...
// Función para mostrar etiquetas con paginación (Ver Más)
let allTags = [];
let displayedTags = 0;
...
// Función para exportar etiquetas a un archivo de texto
